    ...
    return(
        <header className="header_nav" style={{boxShadow: scrolled?"1px 1px 5px #555":"none"}}>
            ...
            <nav className="header_routes">
                ...
                <Link onClick={()=> setActiveRoute(3)} className="header_link" to="/reviews">Reviews <span className={activeRoute ===3?"notifier_route":"active_route"}></span></Link>
                <Link onClick={()=> setActiveRoute(4)} className="header_link" to="/faq">Faq <span className={activeRoute ===4?"notifier_route":"active_route"}></span></Link>
                <Link onClick={()=> setActiveRoute(6)} className="header_link" to="/contact">Contact <span className={activeRoute ===6?"notifier_route":"active_route"}></span></Link>
            </nav>
