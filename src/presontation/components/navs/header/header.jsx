    ...
    return(
        <header className="header_nav" style={{boxShadow: scrolled?"1px 1px 5px #555":"none"}}>
            ...
            <nav className="header_routes">
                ...
                <Link onClick={()=> setActiveRoute(3)} className="header_link" to="/">Reviews <span className={activeRoute ===3?"notifier_route":"active_route"}></span></Link>
                <Link onClick={()=> setActiveRoute(4)} className="header_link" to="/">Faq <span className={activeRoute ===4?"notifier_route":"active_route"}></span></Link>
                <Link onClick={()=> setActiveRoute(5)} className="header_link" to="/">News <span className={activeRoute ===5?"notifier_route":"active_route"}></span></Link>
                <Link onClick={()=> setActiveRoute(6)} className="header_link" to="/">Contact <span className={activeRoute ===6?"notifier_route":"active_route"}></span></Link>
            </nav>
        </header>
    )
}
